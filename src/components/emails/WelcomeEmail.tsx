  ...
  <div style={{
    ...
    <div style={{
      ...
      <div style={{
        ...
        <h1 style={{ color: '#ffffff', margin: 0, fontSize: '24px' }}>BeachSeeker</h1>
      </div>
      
      <div style={{ padding: '32px' }}>
        <h2 style={{ marginTop: 0 }}>Welcome to Paradise! 🏖️</h2>
        <p style={{ fontSize: '16px', lineHeight: '1.6', color: '#475569' }}>
          Thanks for joining the BeachSeeker community! We're thrilled to have you on board.
        </p>
        <p style={{ fontSize: '16px', lineHeight: '1.6', color: '#475569' }}>
      ...
      <div style={{
        ...
        <p>You're receiving this because you signed up for BeachSeeker with {email}.</p>
        <p>© 2026 BeachSeeker. All rights reserved.</p>
      </div>
    </div>
  </div>
);
